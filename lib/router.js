...
var manageHR = {name: "Manage HR Fields", route : "manageHR"};
var options;
...
Router.map(function () {
	...
	this.route('contractsList', {
		path: '/contracts', // match the root path
		data : function () {
			breadtrail = [dashboard,contractsList];
			return this;
		}
	});
	...
	this.route('dashboard', {
		...
		data : function () {
			breadtrail = [dashboard, userList, manageHR];
			return this;
		}
	});
